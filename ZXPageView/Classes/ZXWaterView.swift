...
public protocol ZXWaterViewDataSource : class {
...
@objc public protocol ZXWaterViewDelegate : class {
    @objc optional func waterView(_ waterView : ZXWaterView, didSelectedAtIndexPath indexPath : IndexPath)
}


public class ZXWaterView: UIView {

    public weak var dataSource  : ZXWaterViewDataSource?
    public weak var delegate    : ZXWaterViewDelegate?

    private var style : ZXPageStyle
    private var titles : [String]
    private var layout : ZXWaterViewLayout
    ...
    public init(frame: CGRect, style : ZXPageStyle, titles : [String], layout : ZXWaterViewLayout) {
        self.style = style
        self.titles = titles
        self.layout = layout
...
extension ZXWaterView : UICollectionViewDelegate {
...
extension ZXWaterView : ZXTitleViewDelegate {
