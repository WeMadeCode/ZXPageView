#
#  Be sure to run `pod spec lint ZXPageViewSpec.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "ZXPageViewSpec"
  s.version      = "0.0.1"
  s.summary      = "ZXPageViewSpec"
  ...
  s.source       = { :git => "https://github.com/WeMadeCode/ZXPageView.git", :tag => "#{s.version}" }
